  ...
  var loading_indicator_controller_default = class extends Controller {
    ...
    async loadData(event) {
      ...
      try {
        ...
        this.recommendationsFrameTarget.innerHTML = this.formatRecommendations(data);
      } catch (error2) {
    ...
    formatRecommendations(data) {
      return data.map((item) => `<div class="recommendation-item">${item.name}</div>`).join("");
    }
  };
...
//# sourceMappingURL=/assets/application.js-bf3d2804de8f9dcbedf08281c2db1c64abc2b13a80b691d94bdb4b222a7315cc.map
//!
;
