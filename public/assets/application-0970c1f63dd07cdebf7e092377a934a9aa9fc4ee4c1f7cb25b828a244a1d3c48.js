...
%o`, message, error2, detail);
  ...
  // node_modules/@stimulus-components/content-loader/dist/stimulus-content-loader.mjs
  var _ContentLoader = class _ContentLoader2 extends Controller {
    connect() {
      if (!this.hasUrlValue) {
    ...
    fetch() {
      fetch(this.urlValue).then((response) => {
        ...
        this.dispatch("error", { detail: { error: error2 } });
      });
    }
    startRefreshing() {
  ...
  var loading_indicator_controller_default = class extends Controller {
    ...
    async loadData(event) {
      ...
      try {
        ...
        document.body.innerHTML = turboStream;
      } catch (error2) {
        console.error("Error loading recommendations:", error2);
      } finally {
        this.hideLoader();
      }
    }
  ...
  application.register("loading-indicator", loading_indicator_controller_default);

  // app/javascript/application.js
  var application2 = Application.start();
  application2.register("loading-indicator", loading_indicator_controller_default);
})();
//# sourceMappingURL=/assets/application.js-a734e71f520f9a2bfa764542d84b2d2894f44d3c018450674813f05eb2bafd02.map
//!
;
